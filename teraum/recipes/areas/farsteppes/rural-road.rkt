...
(define road-lookable
  (lookable
   ...
   #:adjectives "dirt"
   #:brief "dirt road"
   #:description "The road here is packed dirt; its hue is almost blue."))
(define dirt-lookable
  (lookable
   #:nouns '("dirt" "silt" "loam")
   #:adjectives '("blue" "blue-brown" "brown")
   #:brief "dirt"
   #:description "The dirt here is a blue sort of brown: clay and humus."))
...
(define (rural-road id
  ...
  (let ([standard-nouns (list "road")]
        [standard-brief "road in the Farsteppes"] [standard-description "This is a road in the Farsteppes."]
