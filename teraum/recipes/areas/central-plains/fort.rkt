...
(require (prefix-in basics/ "../../../../rpg-basics/recipes/areas/outdoors/fort.rkt"))
...
(define (fort id
  ...
  (let ([standard-nouns (list "road")]
        [standard-brief "fort in the Central Plains"] [standard-description "This is a fort in the Central Plains."])
    (when nouns
