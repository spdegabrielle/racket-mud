...
(require (prefix-in basics/ "../../../../rpg-basics/recipes/areas/outdoors/village.rkt"))
...
(define (village id
  ...
  (let ([standard-nouns (list "road")]
        [standard-brief "village in the Farsteppes"] [standard-description "This is a village in the Farsteppes."])
    (when nouns
